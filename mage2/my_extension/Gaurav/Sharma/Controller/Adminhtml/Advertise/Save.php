...
class Save extends \Gaurav\Sharma\Controller\Adminhtml\Advertise
{
        ...
        if ($this->getRequest()->getPostValue()) {
            try {
                ...
                if ($this->getRequest()->getParam('back')) {
                    $this->_redirect('gaurav_sharma/*/edit', ['id' => $model->getId()]);
                    return;
                }
                ...
                if (!empty($id)) {
                    $this->_redirect('gaurav_sharma/*/edit', ['id' => $id]);
                } else {
                    $this->_redirect('gaurav_sharma/*/new');
                }
                return;
            } catch (\Exception $e) {
