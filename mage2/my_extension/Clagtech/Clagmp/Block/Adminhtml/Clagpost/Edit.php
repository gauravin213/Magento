 ...
 */
namespace Clagtech\Clagmp\Block\Adminhtml\Clagpost;
...
class Edit extends \Magento\Backend\Block\Widget\Form\Container
{
    ...
    protected function _construct()
    {
        ...
        parent::_construct();
        $this->buttonList->update('save', 'label', __('Save ClagPost'));
        $this->buttonList->add(
            'save-and-continue',
            [
    ...
    public function getHeaderText()
    {
        ...
        if ($post->getId()) {
            return __("Edit ClagPost '%1'", $this->escapeHtml($post->getName()));
        }
        return __('New Post');
    }
}
