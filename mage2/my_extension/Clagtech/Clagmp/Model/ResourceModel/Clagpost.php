 ...
 */
namespace Clagtech\Clagmp\Model\ResourceModel;

class Clagpost extends \Magento\Framework\Model\ResourceModel\Db\AbstractDb
{
    /**
     * Date model
     * 
    ...
    {
        $this->_init('clagtech_clagmp_clagpost', 'id');
    }
